...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
  if(isset($_POST['submit']))
  {
    ...
    $sql="insert into homeseeker(username,email,phone,Address,password,status,nid,name) values('$uname','$email','$phone','$address','$pass','$status','$nid','$name')";
